       ...
       <div class="row">
          <div class="col-md-12">
             <div class="social_icons"data-aos="fade-up" data-aos-once="true">
                <a href="{{ get_settings('twitter') }}" class="icon" ><i class="fa fa-twitter" aria-hidden="true"></i></a>
                <a href="{{ get_settings('linkedin') }}" class="icon"><i class="fa fa-linkedin" aria-hidden="true"></i></a>
                <a href="{{ get_settings('facebook') }}" class="icon"><i class="fa fa-facebook" aria-hidden="true"></i></a>
             </div>
          </div>
       </div>
    </div>
