    ...
    <div class="container">
        <div class="row">
           ...
           Connect with our  
             ...
             <div class="contact_icon_box">
              <div class="row">
                <div class="col-md-6 mt-3">
                  <div
                    class="contact_icon_container d-flex align-items-center justify-content-center flex-column gap-4 text-center"
                    data-aos="fade-up"
                    data-aos-once="true"
                  >
                    <img
                      src="assets/frontend/images/loaction.png"
                      class="contact_icon"
                      alt="Contact Icon"
                    />
             ...
             <!-- <div class="">   
                  <a href="/contact-us" contenteditable="false" style="cursor: pointer;"> 
